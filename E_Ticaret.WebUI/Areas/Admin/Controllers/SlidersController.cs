...
namespace E_Ticaret.WebUI.Areas.Admin.Controllers
{
    ...
    public class SlidersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, Slider slider, IFormFile? Image, bool checkBoxResmiSil = false)
        {
            if (id != slider.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (Image is not null) slider.Image = await FileHelper.FileLoaderAsync(Image, "/Img/Slider/");
